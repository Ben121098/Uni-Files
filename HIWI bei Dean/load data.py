...
def template_simulator(model,init_ind=0):
    ...
    simulator.u0['e0_greek_sigma_R'] = trajectory[Flowsheet.'e0_greek_sigma_R'][idx]
    simulator.u0['e0_greek_eta_L_st1'] = trajectory[Flowsheet.'e0_greek_eta_L_st1'][idx]
    simulator.u0['e0_greek_eta_L_st2'] = trajectory[Flowsheet.'e0_greek_eta_L_st2'][idx]
    simulator.u0['e0_greek_eta_L_st3'] = trajectory[Flowsheet.'e0_greek_eta_L_st3'][idx]
    simulator.u0['e0_greek_eta_L_st4'] = trajectory[Flowsheet.'e0_greek_eta_L_st4'][idx]
    simulator.u0['e0_greek_eta_L_st5'] = trajectory[Flowsheet.'e0_greek_eta_L_st5'][idx]
    simulator.u0['e0_greek_eta_L_st6'] = trajectory[Flowsheet.'e0_greek_eta_L_st6'][idx]
    simulator.u0['e0_greek_eta_L_st7'] = trajectory[Flowsheet.'e0_greek_eta_L_st7'][idx]
    simulator.u0['e0_greek_eta_L_st8'] = trajectory[Flowsheet.'e0_greek_eta_L_st8'][idx]
    simulator.u0['e0_greek_gamma_st1_i1'] = trajectory[Flowsheet.'e0_greek_gamma_st1_i1'][idx]
    simulator.u0['e0_greek_gamma_st2_i1'] = trajectory[Flowsheet.'e0_greek_gamma_st2_i1'][idx]
    simulator.u0['e0_greek_gamma_st3_i1'] = trajectory[Flowsheet.'e0_greek_gamma_st3_i1'][idx]
    simulator.u0['e0_greek_gamma_st4_i1'] = trajectory[Flowsheet.'e0_greek_gamma_st4_i1'][idx]
    simulator.u0['e0_greek_gamma_st5_i1'] = trajectory[Flowsheet.'e0_greek_gamma_st5_i1'][idx]
    simulator.u0['e0_greek_gamma_st6_i1'] = trajectory[Flowsheet.'e0_greek_gamma_st6_i1'][idx]
    simulator.u0['e0_greek_gamma_st7_i1'] = trajectory[Flowsheet.'e0_greek_gamma_st7_i1'][idx]
    simulator.u0['e0_greek_gamma_st8_i1'] = trajectory[Flowsheet.'e0_greek_gamma_st8_i1'][idx]
    simulator.u0['e0_greek_gamma_st1_i2'] = trajectory[Flowsheet.'e0_greek_gamma_st1_i2'][idx]
    simulator.u0['e0_greek_gamma_st2_i2'] = trajectory[Flowsheet.'e0_greek_gamma_st2_i2'][idx]
    simulator.u0['e0_greek_gamma_st3_i2'] = trajectory[Flowsheet.'e0_greek_gamma_st3_i2'][idx]
    simulator.u0['e0_greek_gamma_st4_i2'] = trajectory[Flowsheet.'e0_greek_gamma_st4_i2'][idx]
    simulator.u0['e0_greek_gamma_st5_i2'] = trajectory[Flowsheet.'e0_greek_gamma_st5_i2'][idx]
    simulator.u0['e0_greek_gamma_st6_i2'] = trajectory[Flowsheet.'e0_greek_gamma_st6_i2'][idx]
    simulator.u0['e0_greek_gamma_st7_i2'] = trajectory[Flowsheet.'e0_greek_gamma_st7_i2'][idx]
    simulator.u0['e0_greek_gamma_st8_i2'] = trajectory[Flowsheet.'e0_greek_gamma_st8_i2'][idx]
    simulator.u0['e0_greek_rho_st1_i1'] = trajectory[Flowsheet.'e0_greek_rho_st1_i1'][idx]
    simulator.u0['e0_greek_rho_st2_i1'] = trajectory[Flowsheet.'e0_greek_rho_st2_i1'][idx]
    simulator.u0['e0_greek_rho_st3_i1'] = trajectory[Flowsheet.'e0_greek_rho_st3_i1'][idx]
    simulator.u0['e0_greek_rho_st4_i1'] = trajectory[Flowsheet.'e0_greek_rho_st4_i1'][idx]
    simulator.u0['e0_greek_rho_st5_i1'] = trajectory[Flowsheet.'e0_greek_rho_st5_i1'][idx]
    simulator.u0['e0_greek_rho_st6_i1'] = trajectory[Flowsheet.'e0_greek_rho_st6_i1'][idx]
    simulator.u0['e0_greek_rho_st7_i1'] = trajectory[Flowsheet.'e0_greek_rho_st7_i1'][idx]
    simulator.u0['e0_greek_rho_st8_i1'] = trajectory[Flowsheet.'e0_greek_rho_st8_i1'][idx]
    simulator.u0['e0_greek_rho_st1_i2'] = trajectory[Flowsheet.'e0_greek_rho_st1_i2'][idx]
    simulator.u0['e0_greek_rho_st2_i2'] = trajectory[Flowsheet.'e0_greek_rho_st2_i2'][idx]
    simulator.u0['e0_greek_rho_st3_i2'] = trajectory[Flowsheet.'e0_greek_rho_st3_i2'][idx]
    simulator.u0['e0_greek_rho_st4_i2'] = trajectory[Flowsheet.'e0_greek_rho_st4_i2'][idx]
    simulator.u0['e0_greek_rho_st5_i2'] = trajectory[Flowsheet.'e0_greek_rho_st5_i2'][idx]
    simulator.u0['e0_greek_rho_st6_i2'] = trajectory[Flowsheet.'e0_greek_rho_st6_i2'][idx]
    simulator.u0['e0_greek_rho_st7_i2'] = trajectory[Flowsheet.'e0_greek_rho_st7_i2'][idx]
    simulator.u0['e0_greek_rho_st8_i2'] = trajectory[Flowsheet.'e0_greek_rho_st8_i2'][idx]
    simulator.u0['e0_greek_rho_st1_i3'] = trajectory[Flowsheet.'e0_greek_rho_st1_i3'][idx]
    simulator.u0['e0_greek_rho_st2_i3'] = trajectory[Flowsheet.'e0_greek_rho_st2_i3'][idx]
    simulator.u0['e0_greek_rho_st3_i3'] = trajectory[Flowsheet.'e0_greek_rho_st3_i3'][idx]
    simulator.u0['e0_greek_rho_st4_i3'] = trajectory[Flowsheet.'e0_greek_rho_st4_i3'][idx]
    simulator.u0['e0_greek_rho_st5_i3'] = trajectory[Flowsheet.'e0_greek_rho_st5_i3'][idx]
    simulator.u0['e0_greek_rho_st6_i3'] = trajectory[Flowsheet.'e0_greek_rho_st6_i3'][idx]
    simulator.u0['e0_greek_rho_st7_i3'] = trajectory[Flowsheet.'e0_greek_rho_st7_i3'][idx]
    simulator.u0['e0_greek_rho_st8_i3'] = trajectory[Flowsheet.'e0_greek_rho_st8_i3'][idx]
    simulator.u0['e0_greek_eta_L_st0'] = trajectory[Flowsheet.'e0_greek_eta_L_st0'][idx]
    simulator.u0['e0_K_st0_i3'] = trajectory[Flowsheet.'e0_K_st0_i3'][idx]
    simulator.u0['e0_L_film_st0'] = trajectory[Flowsheet.'e0_L_film_st0'][idx]
    simulator.u0['e0_K_st1_i3'] = trajectory[Flowsheet.'e0_K_st1_i3'][idx]
    simulator.u0['e0_K_st2_i3'] = trajectory[Flowsheet.'e0_K_st2_i3'][idx]
    simulator.u0['e0_K_st3_i3'] = trajectory[Flowsheet.'e0_K_st3_i3'][idx]
    simulator.u0['e0_K_st4_i3'] = trajectory[Flowsheet.'e0_K_st4_i3'][idx]
    simulator.u0['e0_K_st5_i3'] = trajectory[Flowsheet.'e0_K_st5_i3'][idx]
    simulator.u0['e0_K_st6_i3'] = trajectory[Flowsheet.'e0_K_st6_i3'][idx]
    simulator.u0['e0_K_st7_i3'] = trajectory[Flowsheet.'e0_K_st7_i3'][idx]
    simulator.u0['e0_K_st8_i3'] = trajectory[Flowsheet.'e0_K_st8_i3'][idx]
    simulator.u0['e0_L_film_st1'] = trajectory[Flowsheet.'e0_L_film_st1'][idx]
    simulator.u0['e0_L_film_st2'] = trajectory[Flowsheet.'e0_L_film_st2'][idx]
    simulator.u0['e0_L_film_st3'] = trajectory[Flowsheet.'e0_L_film_st3'][idx]
    simulator.u0['e0_L_film_st4'] = trajectory[Flowsheet.'e0_L_film_st4'][idx]
    simulator.u0['e0_L_film_st5'] = trajectory[Flowsheet.'e0_L_film_st5'][idx]
    simulator.u0['e0_L_film_st6'] = trajectory[Flowsheet.'e0_L_film_st6'][idx]
    simulator.u0['e0_L_film_st7'] = trajectory[Flowsheet.'e0_L_film_st7'][idx]
    simulator.u0['e0_L_film_st8'] = trajectory[Flowsheet.'e0_L_film_st8'][idx]
    simulator.u0['e0_P_SP'] = trajectory[Flowsheet.'e0_P_SP'][idx]
    simulator.u0['e0_P_amb'] = trajectory[Flowsheet.'e0_P_amb'][idx]
    simulator.u0['e0_Q_st1'] = trajectory[Flowsheet.'e0_Q_st1'][idx]
    simulator.u0['e0_Q_st2'] = trajectory[Flowsheet.'e0_Q_st2'][idx]
    simulator.u0['e0_Q_st3'] = trajectory[Flowsheet.'e0_Q_st3'][idx]
    simulator.u0['e0_Q_st0'] = trajectory[Flowsheet.'e0_Q_st0'][idx]
    simulator.u0['e0_Q_st4'] = trajectory[Flowsheet.'e0_Q_st4'][idx]
    simulator.u0['e0_Q_st5'] = trajectory[Flowsheet.'e0_Q_st5'][idx]
    simulator.u0['e0_Q_st6'] = trajectory[Flowsheet.'e0_Q_st6'][idx]
    simulator.u0['e0_Q_st7'] = trajectory[Flowsheet.'e0_Q_st7'][idx]
    simulator.u0['e0_Q_st8'] = trajectory[Flowsheet.'e0_Q_st8'][idx]
    simulator.u0['e0_greek_gamma_st0_i1'] = trajectory[Flowsheet.'e0_greek_gamma_st0_i1'][idx]
    simulator.u0['e0_V_tot_st1'] = trajectory[Flowsheet.'e0_V_tot_st1'][idx]
    simulator.u0['e0_V_tot_st2'] = trajectory[Flowsheet.'e0_V_tot_st2'][idx]
    simulator.u0['e0_V_tot_st3'] = trajectory[Flowsheet.'e0_V_tot_st3'][idx]
    simulator.u0['e0_V_tot_st4'] = trajectory[Flowsheet.'e0_V_tot_st4'][idx]
    simulator.u0['e0_V_tot_st5'] = trajectory[Flowsheet.'e0_V_tot_st5'][idx]
    simulator.u0['e0_V_tot_st6'] = trajectory[Flowsheet.'e0_V_tot_st6'][idx]
    simulator.u0['e0_V_tot_st7'] = trajectory[Flowsheet.'e0_V_tot_st7'][idx]
    simulator.u0['e0_V_tot_st8'] = trajectory[Flowsheet.'e0_V_tot_st8'][idx]
    simulator.u0['e0_V_Lspec_correlation_st1'] = trajectory[Flowsheet.'e0_V_Lspec_correlation_st1'][idx]
    simulator.u0['e0_V_Lspec_correlation_st2'] = trajectory[Flowsheet.'e0_V_Lspec_correlation_st2'][idx]
    simulator.u0['e0_V_Lspec_correlation_st3'] = trajectory[Flowsheet.'e0_V_Lspec_correlation_st3'][idx]
    simulator.u0['e0_V_Lspec_correlation_st4'] = trajectory[Flowsheet.'e0_V_Lspec_correlation_st4'][idx]
    simulator.u0['e0_V_Lspec_correlation_st5'] = trajectory[Flowsheet.'e0_V_Lspec_correlation_st5'][idx]
    simulator.u0['e0_V_tot_st0'] = trajectory[Flowsheet.'e0_V_tot_st0'][idx]
    simulator.u0['e0_V_Lspec_correlation_st6'] = trajectory[Flowsheet.'e0_V_Lspec_correlation_st6'][idx]
    simulator.u0['e0_V_Lspec_correlation_st7'] = trajectory[Flowsheet.'e0_V_Lspec_correlation_st7'][idx]
    simulator.u0['e0_V_Lspec_correlation_st8'] = trajectory[Flowsheet.'e0_V_Lspec_correlation_st8'][idx]
    simulator.u0['e0_V_V_min_st1'] = trajectory[Flowsheet.'e0_V_V_min_st1'][idx]
    simulator.u0['e0_V_V_min_st2'] = trajectory[Flowsheet.'e0_V_V_min_st2'][idx]
    simulator.u0['e0_V_V_min_st3'] = trajectory[Flowsheet.'e0_V_V_min_st3'][idx]
    simulator.u0['e0_V_V_min_st4'] = trajectory[Flowsheet.'e0_V_V_min_st4'][idx]
    simulator.u0['e0_V_V_min_st5'] = trajectory[Flowsheet.'e0_V_V_min_st5'][idx]
    simulator.u0['e0_V_V_min_st6'] = trajectory[Flowsheet.'e0_V_V_min_st6'][idx]
    simulator.u0['e0_V_V_min_st7'] = trajectory[Flowsheet.'e0_V_V_min_st7'][idx]
    simulator.u0['e0_V_Lspec_correlation_st0'] = trajectory[Flowsheet.'e0_V_Lspec_correlation_st0'][idx]
    simulator.u0['e0_V_V_min_st8'] = trajectory[Flowsheet.'e0_V_V_min_st8'][idx]
    simulator.u0['e0_V_V_min_st0'] = trajectory[Flowsheet.'e0_V_V_min_st0'][idx]
    simulator.u0['e0_a_Cond'] = trajectory[Flowsheet.'e0_a_Cond'][idx]
    simulator.u0['e0_c_V_st1'] = trajectory[Flowsheet.'e0_c_V_st1'][idx]
    simulator.u0['e0_c_V_st2'] = trajectory[Flowsheet.'e0_c_V_st2'][idx]
    simulator.u0['e0_c_V_st3'] = trajectory[Flowsheet.'e0_c_V_st3'][idx]
    simulator.u0['e0_c_V_st4'] = trajectory[Flowsheet.'e0_c_V_st4'][idx]
    simulator.u0['e0_c_V_st5'] = trajectory[Flowsheet.'e0_c_V_st5'][idx]
    simulator.u0['e0_c_V_st6'] = trajectory[Flowsheet.'e0_c_V_st6'][idx]
    simulator.u0['e0_c_V_st7'] = trajectory[Flowsheet.'e0_c_V_st7'][idx]
    simulator.u0['e0_c_V_st8'] = trajectory[Flowsheet.'e0_c_V_st8'][idx]
    simulator.u0['e0_greek_gamma_st0_i2'] = trajectory[Flowsheet.'e0_greek_gamma_st0_i2'][idx]
    simulator.u0['e0_c_V_st0'] = trajectory[Flowsheet.'e0_c_V_st0'][idx]
    simulator.u0['e0_greek_rho_st0_i1'] = trajectory[Flowsheet.'e0_greek_rho_st0_i1'][idx]
    simulator.u0['e0_greek_gamma_st9_i1'] = trajectory[Flowsheet.'e0_greek_gamma_st9_i1'][idx]
    simulator.u0['e0_greek_gamma_st9_i2'] = trajectory[Flowsheet.'e0_greek_gamma_st9_i2'][idx]
    simulator.u0['e0_greek_rho_st9_i1'] = trajectory[Flowsheet.'e0_greek_rho_st9_i1'][idx]
    simulator.u0['e0_greek_rho_st9_i2'] = trajectory[Flowsheet.'e0_greek_rho_st9_i2'][idx]
    simulator.u0['e0_greek_rho_st9_i3'] = trajectory[Flowsheet.'e0_greek_rho_st9_i3'][idx]
    simulator.u0['e0_F_F_st9'] = trajectory[Flowsheet.'e0_F_F_st9'][idx]
    simulator.u0['e0_F_L_st9'] = trajectory[Flowsheet.'e0_F_L_st9'][idx]
    simulator.u0['e0_K_st9_i3'] = trajectory[Flowsheet.'e0_K_st9_i3'][idx]
    simulator.u0['e0_P_N2'] = trajectory[Flowsheet.'e0_P_N2'][idx]
    simulator.u0['e0_P_SV_st9'] = trajectory[Flowsheet.'e0_P_SV_st9'][idx]
    simulator.u0['e0_Q_st9'] = trajectory[Flowsheet.'e0_Q_st9'][idx]
    simulator.u0['e0_T_F_st9'] = trajectory[Flowsheet.'e0_T_F_st9'][idx]
    simulator.u0['e0_T_N2_st9'] = trajectory[Flowsheet.'e0_T_N2_st9'][idx]
    simulator.u0['e0_V_tot_st9'] = trajectory[Flowsheet.'e0_V_tot_st9'][idx]
    simulator.u0['e0_V_V_min_st9'] = trajectory[Flowsheet.'e0_V_V_min_st9'][idx]
    simulator.u0['e0_c_N2_st9'] = trajectory[Flowsheet.'e0_c_N2_st9'][idx]
    simulator.u0['e0_c_SV_st9'] = trajectory[Flowsheet.'e0_c_SV_st9'][idx]
    simulator.u0['e0_c_V_st9'] = trajectory[Flowsheet.'e0_c_V_st9'][idx]
    simulator.u0['e0_greek_rho_st0_i2'] = trajectory[Flowsheet.'e0_greek_rho_st0_i2'][idx]
    simulator.u0['e0_x_F_st9_i1'] = trajectory[Flowsheet.'e0_x_F_st9_i1'][idx]
    simulator.u0['e0_x_F_st9_i2'] = trajectory[Flowsheet.'e0_x_F_st9_i2'][idx]
    simulator.u0['e0_x_F_st9_i3'] = trajectory[Flowsheet.'e0_x_F_st9_i3'][idx]
    simulator.u0['e0_x_N2_st9_i1'] = trajectory[Flowsheet.'e0_x_N2_st9_i1'][idx]
    simulator.u0['e0_x_N2_st9_i2'] = trajectory[Flowsheet.'e0_x_N2_st9_i2'][idx]
    simulator.u0['e0_x_N2_st9_i3'] = trajectory[Flowsheet.'e0_x_N2_st9_i3'][idx]
    simulator.u0['e0_greek_rho_st0_i3'] = trajectory[Flowsheet.'e0_greek_rho_st0_i3'][idx]
